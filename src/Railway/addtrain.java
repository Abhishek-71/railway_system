...
public class addtrain extends javax.swing.JFrame {
    ...
    public void Train_Details(){
        try {
            pst = con.prepareStatement("select * from traindetail");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Destinationplace");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tdplace, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(46, 46, 46)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tstartplace, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(txtno)
                            .addComponent(tname))))
                .addGap(38, 38, 38))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = con.prepareStatement("insert into traindetail(tno,tname,startplace,destinationplace,price)values(?,?,?,?,?)");
            pst.setString(1,tno);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            pst = con.prepareStatement("update traindetail set 	tname=?, startplace=?, destinationplace=?, 	price=?   where tno=? ");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            pst = con.prepareStatement("delete from traindetail where tno=? ");
            pst.setString(1,tno);
